...
class LMTrainer():
    def __init__(self, cfg):
        ...
        self.output_dir = f'/model/output/{self.dataset_name}{self.use_gpt_str}/{self.model_name}-seed{self.seed}'
        ...
        self.n_labels = max(data.y) + 1
        
        tokenizer = AutoTokenizer.from_pretrained(self.model_name, cache_dir='/model')
        ...
        bert_model = AutoModel.from_pretrained(self.model_name, cache_dir='/model')
